<p align="center">
  <img src="./public/editor_cube_transparent.png" width="120" height="120" alt="EDITOR GRATUITO">
</p>

<h1 align="center">editor.app.br</h1>
...
**editor.app.br** 是一款强大的 Web 应用程序，旨在为您提供在浏览器中直接查看和编辑 Office 文档（Word、Excel、PowerPoint）的无缝体验。它基于“本地优先”的设计理念，在提供桌面级编辑体验的同时，确保您的文档隐私和安全。

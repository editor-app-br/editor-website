...
export const metadata: Metadata = {
  title: "Free Office Templates — Word, Excel & PowerPoint",
  description:
  ...
  alternates: {
    canonical: "https://editor.app.br/template",
  },
  openGraph: {
    title: "Free Office Templates — Word, Excel & PowerPoint | EDITOR GRATUITO",
    description:
      "Free professional templates for Word, Excel, and PowerPoint. Edit directly in your browser — no login needed.",
    url: "https://editor.app.br/template",
    type: "website",
  },
  twitter: {

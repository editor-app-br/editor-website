...
const AGENT_COMMANDS = [
  ...
  { name: "insert_text / type", detail: "Insere ou digita no cursor (fonte, tamanho, negrito opcionais). HTML inline <b> <i> <u> <br> vira formatação." },
  { name: "replace_selection", detail: "Substitui a seleção (mesmo HTML inline)." },

...
const ORANGE = "#FF5900";
const LOGO_PATH = path.join(process.cwd(), "public", "editor_cube_transparent.png");
...
async function getLogoDataUri() {
  ...
  try {
    ...
    console.error("Failed to read editor cube logo");
  }
  return logoDataUri;
}
      ...
      <div tw="flex flex-col justify-between flex-1 p-16" style={{ display: "flex" }}>
        ...
        <div tw="flex items-center" style={{ display: "flex" }}>
          {logoBase64 ? (
            ...
            >
              <span tw="text-white text-3xl font-black">e</span>
            </div>
          )}
          <span
